...
Release 34693721741 / job 103553456812 已确认 completed/failure，失败步骤 Validate source：同 232 的 .cache 缺失导致 15 项初始化失败，其他 4221 项通过、24 跳过。未进入安装包构建和发布。该标签不重写；修复后的新候选改为 alpha.14。
