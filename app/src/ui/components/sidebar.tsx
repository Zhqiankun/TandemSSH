      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>
              <LocalizedText id="sidebar" />
            </SheetTitle>
            <SheetDescription>
              <LocalizedText id="mobileSidebar" />
            </SheetDescription>
          </SheetHeader>
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">
        <LocalizedText id="toggleSidebar" />
      </span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={translateUiText("Toggle Sidebar")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={translateUiText("Toggle Sidebar")}
      className={cn(
