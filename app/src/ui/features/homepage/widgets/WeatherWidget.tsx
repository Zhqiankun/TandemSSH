  ...
  if (!location) {
    return (
      <div className="flex items-center justify-center w-full h-full text-xs text-muted-foreground/60 p-3 text-center">
        <LocalizedText id="weatherLocation" />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center w-full h-full text-xs text-destructive/70 p-3 text-center">
        <LocalizedText id="weatherFailed" />
        {location}"
      </div>
    );
  }
        ...
        <div className="flex items-center gap-3 flex-1 min-h-0">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-[10px] text-muted-foreground/70">
              <LocalizedText id="feelsLike" /> {displayFeels}
            </span>
          </div>
        </div>
...
registerWidget<WeatherConfig>({
  ...
  name: "Weather",
  get description() {
    return translateUiText("Live weather for any location");
  },
  category: "info",
  icon: <Sun size={14} />,
