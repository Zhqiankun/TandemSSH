import type { MacroStep, TerminalMacro } from "../../types/legacy-commands";
export type { MacroStep, TerminalMacro } from "../../types/legacy-commands";
import { legacyRawInputEnabled } from "../../domain/commands/legacy-policy";
...
export async function runTerminalMacro(
  ...
  if (!legacyRawInputEnabled) throw Error("CONTROLLED_MACRO_REQUIRED");
  let output = "";
  let scanFrom = 0;
