...
const TRIGGER_TYPES = [
  {
    value: "host_offline",
    get label() {
      return translateUiText("Host Offline");
    },
    hasThreshold: false,
  },
  {
    value: "host_online",
    get label() {
      return translateUiText("Host Online");
    },
    hasThreshold: false,
  },
  {
    value: "cpu_threshold",
    get label() {
      return translateUiText("CPU Usage Threshold");
    },
    hasThreshold: true,
  },
  {
    ...
    get label() {
      return translateUiText("Memory Usage Threshold");
    },
    hasThreshold: true,
  },
  {
    ...
    get label() {
      return translateUiText("Disk Usage Threshold");
    },
    hasThreshold: true,
  },
  {
    ...
    get label() {
      return translateUiText("Health Check Failure");
    },
    hasThreshold: false,
  },
  {
    value: "user_login",
    get label() {
      return translateUiText("User SSH Login");
    },
    hasThreshold: false,
  },
];
