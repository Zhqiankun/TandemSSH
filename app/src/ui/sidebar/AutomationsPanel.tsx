...
export function AutomationsPanel({
  ...
  async function run(row: AutomationRow, dryRun: boolean) {
    if (!legacyAutomationExecutionEnabled) {
      toast.info(t("tandem.legacy.automationNotice"));
      return;
    }
    try {
  ...
  if (editorOpen) {
    ...
    return (
      <div className="flex flex-col h-full min-h-0">
        <p
          role="status"
          className="m-3 border border-border bg-muted p-3 text-xs"
        >
          {t("tandem.legacy.automationNotice")}
        </p>
        <button
          onClick={closeEditor}
  ...
  return (
    <>
      <p
        role="status"
        className="m-3 border border-border bg-muted p-3 text-xs leading-relaxed"
      >
        {t("tandem.legacy.automationNotice")}
      </p>
      {
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <Button
                          ...
                          disabled={!legacyAutomationExecutionEnabled}
