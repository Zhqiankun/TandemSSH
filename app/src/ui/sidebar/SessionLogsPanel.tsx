        ...
        {retentionDays != null && (
          <div className="flex items-center gap-2 border-b border-border/60 px-3 py-2 text-[10px] text-muted-foreground">
            ...
            <Input
              ...
              aria-label={translateUiText("Recording retention days")}
            />
            <span>
              <LocalizedText id="days" />
            </span>
            <button
              type="button"
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  toast.success(translateUiText("Recording retention updated"));
                } catch {
                  toast.error(
                    translateUiText("Failed to update recording retention"),
                  );
                } finally {
              ...
              aria-label={translateUiText("Save recording retention")}
            >
              {savingRetention ? (
            ...
            {filtered.length === 0 ? (
              <div className="flex flex-col items-center justify-center gap-2 py-10 text-center">
                <span className="text-xs text-muted-foreground/50">
                  <LocalizedText id="noResultsPrefix" />
                  {filter}&quot;
                </span>
              </div>
            ) : (
