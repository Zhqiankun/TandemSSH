      ...
      >
        <div className="flex flex-col gap-4 py-3">
          <div className="flex flex-col gap-1.5">
            ...
            >
              <option value="any">
                <LocalizedText id="any" />
              </option>
              <option value="nla">NLA</option>
              <option value="nla-ext">
                <LocalizedText id="nlaExtended" />
              </option>
      ...
      >
        <div className="flex flex-col gap-4 py-3">
          <div className="flex flex-col gap-1.5">
            ...
            >
              <option value="auto">
                <LocalizedText id="auto" />
              </option>
              <option value="8">
                <LocalizedText id="8bit" />
              </option>
              <option value="16">
                <LocalizedText id="16bit" />
              </option>
              <option value="24">
                <LocalizedText id="24bit" />
              </option>
              <option value="32">
                <LocalizedText id="32bit" />
              </option>
            </select>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="display-update">
                <LocalizedText id="displayUpdate" />
              </option>
              <option value="reconnect">
                <LocalizedText id="reconnect" />
              </option>
            </select>
          </div>
          <SettingRow
      ...
      >
        <div className="flex flex-col gap-4 py-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              placeholder={translateUiText("e.g. cmd.exe")}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              placeholder={translateUiText("e.g. America/New_York")}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="preserve">
                <LocalizedText id="preserve" />
              </option>
              <option value="unix">
                <LocalizedText id="unixLf" />
              </option>
              <option value="windows">
                <LocalizedText id="windowsCrlf" />
              </option>
            </select>
          </div>
          <SettingRow
        ...
        <div className="flex flex-col gap-4 py-3">
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="local">
                <LocalizedText id="local" />
              </option>
              <option value="remote">
                <LocalizedText id="remote" />
              </option>
            </select>
          </div>
          <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="black-white">
                <LocalizedText id="blackWhite" />
              </option>
              <option value="white-black">
                <LocalizedText id="whiteBlack" />
              </option>
              <option value="gray-black">
                <LocalizedText id="grayBlack" />
              </option>
              <option value="green-black">
                <LocalizedText id="greenBlack" />
              </option>
            </select>
          </div>
          <div className="flex flex-col gap-1.5">
