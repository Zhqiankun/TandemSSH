// Reference algorithm coverage only; production execution is independently tested as disabled.
vi.mock("../../../domain/commands/legacy-policy.js", () => ({
  legacyAutomationExecutionEnabled: true,
  LEGACY_AUTOMATION_BLOCKED: "LEGACY_AUTOMATION_REQUIRES_MIGRATION",
}));
