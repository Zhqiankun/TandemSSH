 ...
 * exist for anyone, regardless of what any user has enabled. Server mode defaults to
 * false. Desktop mode makes the feature available by default; personal opt-in and an explicit task still precede any model request.
 *
