...
export const hosts = sqliteTable(
  "ssh_data",
  {
    ...
    useWarpgate: integer("use_warpgate", { mode: "boolean" })
      .notNull()
      .default(false),
    ...
    enableFileManager: integer("enable_file_manager", { mode: "boolean" })
      .notNull()
      .default(true),
    scpLegacy: integer("scp_legacy", { mode: "boolean" })
      .notNull()
      .default(false),
    ...
    enableTmuxMonitor: integer("enable_tmux_monitor", { mode: "boolean" })
      .notNull()
      .default(false),
    enableTerminalToolbar: integer("enable_terminal_toolbar", {
      mode: "boolean",
    })
      .notNull()
      .default(true),
    showTerminalInSidebar: integer("show_terminal_in_sidebar", {
      mode: "boolean",
    })
      .notNull()
      .default(true),
    showFileManagerInSidebar: integer("show_file_manager_in_sidebar", {
      mode: "boolean",
    })
      .notNull()
      .default(false),
    ...
    showDockerInSidebar: integer("show_docker_in_sidebar", { mode: "boolean" })
      .notNull()
      .default(false),
    showServerStatsInSidebar: integer("show_server_stats_in_sidebar", {
      mode: "boolean",
    })
      .notNull()
      .default(false),
    ...
    notes: text("notes"),
    enableSsh: integer("enable_ssh", { mode: "boolean" })
      .notNull()
      .default(true),
    enableRdp: integer("enable_rdp", { mode: "boolean" })
      .notNull()
      .default(false),
    enableVnc: integer("enable_vnc", { mode: "boolean" })
      .notNull()
      .default(false),
    enableTelnet: integer("enable_telnet", { mode: "boolean" })
      .notNull()
      .default(false),
    ...
    rdpCredentialId: integer("rdp_credential_id").references(
      () => sshCredentials.id,
      { onDelete: "set null" },
    ),
    ...
    rdpIgnoreCert: integer("rdp_ignore_cert", { mode: "boolean" }).default(
      false,
    ),

    vncCredentialId: integer("vnc_credential_id").references(
      () => sshCredentials.id,
      { onDelete: "set null" },
    ),
    ...
    telnetCredentialId: integer("telnet_credential_id").references(
      () => sshCredentials.id,
      { onDelete: "set null" },
    ),
...
export const opksshTokens = sqliteTable(
  ...
  // SQLite deployment forbids — and the upsert had nothing to conflict on.
  (table) => [
    uniqueIndex("idx_opkssh_tokens_user_host").on(table.userId, table.hostId),
  ],
);
...
export const vaultTokens = sqliteTable(
  ...
  // SQLite deployment forbids — and the upsert had nothing to conflict on.
  (table) => [
    uniqueIndex("idx_vault_tokens_user_profile").on(
      table.userId,
      table.profileId,
    ),
  ],
...
export const userPreferences = sqliteTable("user_preferences", {
  ...
  commandPaletteEnabled: integer("command_palette_enabled", {
    mode: "boolean",
  }),
  ...
  confirmSnippetExecution: integer("confirm_snippet_execution", {
    mode: "boolean",
  }),
...
export const hostMetricsPreferences = sqliteTable(
  ...
  (table) => [
    uniqueIndex("idx_host_metrics_prefs_user_host").on(
      table.userId,
      table.hostId,
    ),
  ],
...
export const proxmoxStatsPreferences = sqliteTable(
  ...
  (table) => [
    uniqueIndex("idx_proxmox_stats_prefs_user_host").on(
      table.userId,
      table.hostId,
    ),
  ],
...
export const hostHealthChecks = sqliteTable(
  ...
  (table) => [
    uniqueIndex("idx_host_health_checks_user_host").on(
      table.userId,
      table.hostId,
    ),
  ],
...
export const hostTrustRecords = sqliteTable("tandem_ssh_trust", {
  id: text("id").primaryKey(),
  userId: text("user_id")
    .notNull()
    .references(() => users.id, { onDelete: "cascade" }),
  profileScope: text("profile_scope").notNull(),
