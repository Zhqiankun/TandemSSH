...
export const hosts = mysqlTable(
  "ssh_data",
  {
    ...
    rdpCredentialId: int("rdp_credential_id").references(
      () => sshCredentials.id,
      { onDelete: "set null" },
    ),
    ...
    vncCredentialId: int("vnc_credential_id").references(
      () => sshCredentials.id,
      { onDelete: "set null" },
    ),
    ...
    telnetCredentialId: int("telnet_credential_id").references(
      () => sshCredentials.id,
      { onDelete: "set null" },
    ),
...
export const hostTrustRecords = mysqlTable("tandem_ssh_trust", {
  id: varchar("id", { length: 255 }).primaryKey(),
  userId: varchar("user_id", { length: 255 })
    .notNull()
    .references(() => users.id, { onDelete: "cascade" }),
