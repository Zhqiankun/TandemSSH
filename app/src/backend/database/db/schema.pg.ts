...
export const hosts = pgTable(
  "ssh_data",
  {
    ...
    useWarpgate: boolean("use_warpgate")
      .notNull()
      .default(false),
    ...
    notes: text("notes"),
    enableSsh: boolean("enable_ssh")
      .notNull()
      .default(true),
    enableRdp: boolean("enable_rdp")
      .notNull()
      .default(false),
    enableVnc: boolean("enable_vnc")
      .notNull()
      .default(false),
    enableTelnet: boolean("enable_telnet")
      .notNull()
      .default(false),
    ...
    rdpIgnoreCert: boolean("rdp_ignore_cert").default(
      false,
    ),
...
export const hostTrustRecords = pgTable("tandem_ssh_trust", {
  id: varchar("id", { length: 255 }).primaryKey(),
  userId: varchar("user_id", { length: 255 })
    .notNull()
    .references(() => users.id, { onDelete: "cascade" }),
